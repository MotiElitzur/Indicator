...
//
//class IndicatorService(val bcontext: Context, onServiceConnected: (ForrestService) -> Unit
//) : Forrest(bcontext, onServiceConnected) {
//
...
//        mKeyguardManager = context.getSystemService(KEYGUARD_SERVICE) as KeyguardManager
//        mIndicatorNotification = IndicatorNotification(this)
//    }
//
//    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
//        intent.extras?.let { handleConfigChange(it) }
//        createNotification()
//        restartNotifying()
...
//            screenBroadcastIntentFilter.priority = 1000
//        }
//        if (mNotificationCreated) {
//            context.unregisterReceiver(mScreenBroadcastReceiver)
//        }
//        context.registerReceiver(mScreenBroadcastReceiver, screenBroadcastIntentFilter)
//
